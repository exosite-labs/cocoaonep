...
{
    return [self initWithCompare:[self comparisonFromString:plist[@"comparison"]] constant:plist[@"constant"] count:plist[@"count"] timeout:plist[@"timeout"] repeat:[plist[@"repeat"] boolValue]];
}
