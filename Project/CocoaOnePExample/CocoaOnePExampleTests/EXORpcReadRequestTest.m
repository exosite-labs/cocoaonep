...
- (void)testAllocAndInit
{
    ...
    read = [EXORpcReadRequest readWithRID:rid complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:nil endTime:nil ascending:NO limit:1 selection:EXORpcReadSelectionTypeAutoWindow complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:nil endTime:nil ascending:YES limit:1 selection:EXORpcReadSelectionTypeAutoWindow complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:nil endTime:nil ascending:NO limit:1 selection:EXORpcReadSelectionTypeGivenWindow complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:nil endTime:nil ascending:NO limit:212 selection:EXORpcReadSelectionTypeAll complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:date endTime:nil ascending:NO limit:1 selection:EXORpcReadSelectionTypeAll complete:nil];
    ...
    read = [EXORpcReadRequest readWithRID:rid startTime:nil endTime:date ascending:NO limit:1 selection:EXORpcReadSelectionTypeAll complete:nil];
